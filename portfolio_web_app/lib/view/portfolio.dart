...
class _PortfolioMobileScreenState extends State<PortfolioMobileScreen> {
                                          ...
                                          Padding(
                                            ...
                                            child: Container(
                                              child: Column(
                                                crossAxisAlignment: CrossAxisAlignment.start,
                                                children: [
                                                  Image(image: AssetImage('assets/project_screen_images/smart_crm/cover.png')),
                                                  SizedBox(height: 20),
                                                              ...
                                                              return AlertDialog(
                                                                ...
                                                                content: SingleChildScrollView(
                                                                  ...
                                                                  child: Padding(
                                                                    ...
                                                                    child: ListBody(
                                                                      children: [
                                                                        Image.asset('assets/project_screen_images/smart_crm/image1.jpeg'),
                                                                        SizedBox(height: 20),
                                                                        Image.asset('assets/project_screen_images/smart_crm/image2.jpeg'),
                                                                        SizedBox(height: 20),
                                                                        Image.asset('assets/project_screen_images/smart_crm/image3.jpeg'),
                                                                        SizedBox(height: 20),
                                                                        Image.asset('assets/project_screen_images/smart_crm/image4.jpeg'),
                                                                        SizedBox(height: 20),
                                                                        Image.asset('assets/project_screen_images/smart_crm/image5.jpeg'),
                                                                      ],
                                                                    ),
                                                                  ),
                                                                ),
                                          ...
                                          Padding(
                                            ...
                                            child: Container(
                                              child: Column(
                                                crossAxisAlignment: CrossAxisAlignment.start,
                                                children: [
                                                  Image(image: AssetImage('assets/project_screen_images/dokan_pos_pharmacy/cover.png')),
                                                  SizedBox(height: 20),
                                                              ...
                                                              return AlertDialog(
                                                                ...
                                                                content: SingleChildScrollView(
                                                                  ...
                                                                  child: Padding(
                                                                    ...
                                                                    child: ListBody(
                                                                      children: [
                                                                        Image.asset('assets/project_screen_images/dokan_pos_pharmacy/image 1.png'),
                                                                        SizedBox(height: 20),
                                                                        Image.asset('assets/project_screen_images/dokan_pos_pharmacy/image 2.png'),
                                                                        SizedBox(height: 20),
                                                                        Image.asset('assets/project_screen_images/dokan_pos_pharmacy/image 3.png'),
                                                                        SizedBox(height: 20),
                                                                        Image.asset('assets/project_screen_images/dokan_pos_pharmacy/image 4.png'),
                                                                        SizedBox(height: 20),
                                                                        Image.asset('assets/project_screen_images/dokan_pos_pharmacy/image 5.png'),
                                                                      ],
                                                                    ),
                                                                  ),
                                                                ),
                                          ...
                                          Padding(
                                            ...
                                            child: Container(
                                              child: Column(
                                                crossAxisAlignment: CrossAxisAlignment.start,
                                                children: [
                                                  Image(image: AssetImage('assets/project_screen_images/easy_somity/cover.png')),
                                                  SizedBox(height: 20),
                                                              ...
                                                              return AlertDialog(
                                                                ...
                                                                content: SingleChildScrollView(
                                                                  ...
                                                                  child: Padding(
                                                                    ...
                                                                    child: ListBody(
                                                                      children: [
                                                                        Image.asset('assets/project_screen_images/easy_somity/image 1.png'),
                                                                        SizedBox(height: 20),
                                                                        Image.asset('assets/project_screen_images/easy_somity/image 2.png'),
                                                                        SizedBox(height: 20),
                                                                        Image.asset('assets/project_screen_images/easy_somity/image 3.png'),
                                                                        SizedBox(height: 20),
                                                                        Image.asset('assets/project_screen_images/easy_somity/image 4.png'),
                                                                        SizedBox(height: 20),
                                                                        Image.asset('assets/project_screen_images/easy_somity/image 5.png'),
                                                                        SizedBox(height: 20),
                                                                        Image.asset('assets/project_screen_images/easy_somity/image 6.png'),
                                                                        SizedBox(height: 20),
                                                                        Image.asset('assets/project_screen_images/easy_somity/image 7.png'),
                                                                      ],
                                                                    ),
                                                                  ),
                                                                ),
  ...
  Future<void> _downloadSmartCRM() async {
    String assetPath = 'assets/project_file_for_download/Smart CRM.apk';
    String fileName = 'Smart CRM.apk';
  ...
  Future<void> _downloadEasySomity() async {
    String assetPath = 'assets/project_file_for_download/Easy Somity.apk';
    String fileName = 'Easy Somity.apk';
    await downloadFile(context, assetPath, fileName); // Call the function from the imported file
  }

  Future<void> _downloadDokanPosPharmacy() async {
    String assetPath = 'assets/project_file_for_download/Smart CRM.apk';
    String fileName = 'Dokan Pos Pharmacy.apk';
    await downloadFile(context, assetPath, fileName); // Call the function from the imported file
  }
}
